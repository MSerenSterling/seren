...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _header_flyout_nav__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./header/flyout-nav */ \"./src/js/frontend/header/flyout-nav.js\");\n/* harmony import */ var _header_header_height__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./header/header-height */ \"./src/js/frontend/header/header-height.js\");\n/* harmony import */ var _header_menu_toggle__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./header/menu-toggle */ \"./src/js/frontend/header/menu-toggle.js\");\n\n\n\n\nfunction domReady(fn) {\n  // If we're early to the party\n  document.addEventListener(\"DOMContentLoaded\", fn); // If late; I mean on time.\n\n  if (document.readyState === \"interactive\" || document.readyState === \"complete\") {\n    fn();\n  }\n}\n\ndomReady(() => {\n  (0,_header_flyout_nav__WEBPACK_IMPORTED_MODULE_0__.default)();\n  (0,_header_menu_toggle__WEBPACK_IMPORTED_MODULE_2__.default)();\n  (0,_header_header_height__WEBPACK_IMPORTED_MODULE_1__.default)();\n});\n\n//# sourceURL=webpack://sterling/./src/js/frontend/front-index.js?");
...
/***/ "./src/js/frontend/header/header-height.js":
/*!*************************************************!*\
  !*** ./src/js/frontend/header/header-height.js ***!
  \*************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": function() { return /* binding */ setHeaderHeightVariable; }\n/* harmony export */ });\nfunction setHeaderHeightVariable() {\n  const header = document.querySelector('.site-header');\n  document.documentElement.style.setProperty('--headerHeight', `${header.offsetHeight}px`);\n}\n\n//# sourceURL=webpack://sterling/./src/js/frontend/header/header-height.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": function() { return /* binding */ menuToggle; }\n/* harmony export */ });\n/* harmony import */ var _utility_animate_toggle__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utility/animate-toggle */ \"./src/js/frontend/utility/animate-toggle.js\");\n/* harmony import */ var _utility_listeners__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utility/listeners */ \"./src/js/frontend/utility/listeners.js\");\n/* harmony import */ var _flyout_nav__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./flyout-nav */ \"./src/js/frontend/header/flyout-nav.js\");\n\n\n\nfunction menuToggle() {\n  const toggle = document.getElementById(\"primary-mobile-menu\");\n  const menu = document.getElementById(\"site-navigation\");\n  toggle && toggle.addEventListener('click', toggleMobileMenu);\n  const links = document.querySelectorAll('.menu-item a');\n  links.forEach(link => link.addEventListener('click', toggleMobileMenu));\n\n  function closeMenu() {\n    (0,_utility_animate_toggle__WEBPACK_IMPORTED_MODULE_0__.collapseSection)(menu);\n    toggle.classList.remove('menu-open');\n    document.body.classList.remove('modal-open');\n    (0,_utility_listeners__WEBPACK_IMPORTED_MODULE_1__.removeCloseListeners)(); // Get all open menus so that submenus are also closed on menu close.\n\n    const openMenu = document.querySelectorAll('.menu-item-has-children.submenu-open');\n    openMenu.forEach(openMenu => {\n      _flyout_nav__WEBPACK_IMPORTED_MODULE_2__.FlyoutMenu.closeSubMenu(openMenu);\n    });\n  }\n\n  function toggleMobileMenu() {\n    if (toggle.classList.contains('menu-open')) {\n      closeMenu();\n    } else {\n      (0,_utility_animate_toggle__WEBPACK_IMPORTED_MODULE_0__.expandSection)(menu);\n      document.body.classList.add('modal-open');\n      toggle.classList.add('menu-open');\n      (0,_utility_listeners__WEBPACK_IMPORTED_MODULE_1__.addCloseListeners)(menu, closeMenu, toggle);\n    }\n  }\n}\n\n//# sourceURL=webpack://sterling/./src/js/frontend/header/menu-toggle.js?");
